...
const FaqEntry = ({ question, answer}) => { // each entry will be passed a { question, answer } to build that one element
    ...
    return (
        <li onClick={handleClick} className="py-5 hover:cursor-pointer group border-b-2 border-[#7F90AB]">
        ...
        <div className="relative flex items-center justify-center max-h-xl pb-100 pt-100">
            ...
            />
             <Image
                ...
                priority
            />
            <div className="bg-[#BFBFBF] bg-opacity-20 w-[95%] h-auto border-3 border-t-[white] border-l-[white] border-r-[black] border-b-[black]">
                ...
                <div className="bg-[#030087] bg-opacity-20 w-[99.5%] h-auto px-5 pt-15 pb-15 -mt-4 ml-3 right-0 ">
